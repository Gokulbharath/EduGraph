...
import { Brain, ArrowLeft, Mail, Lock, User, Github } from 'lucide-react';
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          ...
          <h2 className="text-3xl font-bold text-gray-900 mb-2">
            {isLogin ? 'Welcome Back' : 'Join EduGraph'}
          </h2>
          <p className="text-gray-600">
            {isLogin ? 'Sign in to continue your career journey' : 'Start your personalized career discovery'}
          </p>
        </div>
        ...
        <div className="mt-8 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
          <p className="text-yellow-800 text-sm">
            <strong>Setup Required:</strong> To enable authentication, please configure your Firebase project credentials in <code>src/config/firebase.ts</code>
          </p>
        </div>
      </div>
    </div>
